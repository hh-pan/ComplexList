 ...
 * Desc:
 */
public class LoadingView extends AdapterDelegate<List<ItemBean>> {
    ...
    protected boolean isForViewType(@NonNull List<ItemBean> items, int position) {
        return items.get(position).type == 5;
    }

    @NonNull
    @Override
    protected RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent) {
        return new MyViewHolder(inflater.inflate(R.layout.item_load, parent, false));
    }
